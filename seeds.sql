...
INSERT INTO role (title, salary, department_id) VALUES ('HR Leader', 100000.00, 1);
INSERT INTO role (title, salary, department_id) VALUES ('Administrative Manager', 66000,1);
INSERT INTO role (title, salary, department_id) VALUES ('Assistant HR Manager', 75000,1);
INSERT INTO role (title, salary, department_id) VALUES ('Chief People Officer', 50000,1);

INSERT INTO role (title, salary, department_id) VALUES ('Data Analyst', 40000,2);
INSERT INTO role (title, salary, department_id) VALUES ('System Administrator', 80000,2);
INSERT INTO role (title, salary, department_id) VALUES ('Computer Technician', 50000,2);
INSERT INTO role (title, salary, department_id) VALUES ('Network Administrator', 55000,2);

INSERT INTO role (title, salary, department_id) VALUES ('Head of Administration', 150000,3);
INSERT INTO role (title, salary, department_id) VALUES ('Chief Business Officer', 880000,3);
INSERT INTO role (title, salary, department_id) VALUES ('VP of Administration', 50000,3);
INSERT INTO role (title, salary, department_id) VALUES ('Administrative Director', 100000,3);

INSERT INTO role (title, salary, department_id) VALUES ('Web Developer', 100000,4);
INSERT INTO role (title, salary, department_id) VALUES ('Software Engineer', 53000,4);
INSERT INTO role (title, salary, department_id) VALUES ('Software Developer', 78000,4);
INSERT INTO role (title, salary, department_id) VALUES ('Front End Developer', 66000,4);

INSERT INTO role (title, salary, department_id) VALUES ('Brand Ambassador', 80000,5);
INSERT INTO role (title, salary, department_id) VALUES ('Copywriter', 58000,5);
INSERT INTO role (title, salary, department_id) VALUES ('Social Media Manager', 75000,5);
INSERT INTO role (title, salary, department_id) VALUES ('Marketing Manager', 52000,5);

INSERT INTO role (title, salary, department_id) VALUES ('Sales Associate', 30000,6);
INSERT INTO role (title, salary, department_id) VALUES ('Sales Representative', 50000,6);
INSERT INTO role (title, salary, department_id) VALUES ('Account Executive', 75000,6);
INSERT INTO role (title, salary, department_id) VALUES ('Sales Manager', 900000,6);

INSERT INTO role (title, salary, department_id) VALUES ('Chief Communications Office', 150000,7);
INSERT INTO role (title, salary, department_id) VALUES ('Vice President Communications', 990000,7);
INSERT INTO role (title, salary, department_id) VALUES ('PR & Events Manager', 57500,7);
INSERT INTO role (title, salary, department_id) VALUES ('Publicist', 45000,7);
...
INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Jayne','Pettry',6,5);0
